...
{
    private readonly BaseListPageLogic<Models.Genus, GenusItemViewModel> _base;

    /// <summary>
    /// Initialize the genera list page with dependency injection and composition
    /// </summary>
    public GeneraListPage(GeneraListViewModel viewModel)
    {
        ...
        _base = new BaseListPageLogic<Models.Genus, GenusItemViewModel>(viewModel);
        _base.SetupPage(this, GeneraListView, RootGrid, FabButton, ListRefresh);

        this.LogInfo("🚀 REFACTORED GeneraListPage - using BaseListPageLogic composition");
    }
