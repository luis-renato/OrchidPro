...
namespace OrchidPro.Views.Pages.Locations;

/// <summary>
/// LocationsEditPage - seguindo padrão FamilyEditPage
/// </summary>
public partial class LocationsEditPage : ContentPage, IQueryAttributable
{
    private readonly BaseEditPageLogic<Models.PlantLocation> _base;

    public LocationsEditPage(LocationsEditViewModel viewModel)
    {
        InitializeComponent();
        _base = new BaseEditPageLogic<Models.PlantLocation>(viewModel);
        _base.SetupPage(this);
        this.LogInfo("🚀 REFACTORED LocationsEditPage - using BaseEditPageLogic composition");
    }
    ...
    // All event handlers delegated to base - IGUAL ao FamilyEditPage
