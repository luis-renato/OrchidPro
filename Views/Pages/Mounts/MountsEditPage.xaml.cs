...
public partial class MountsEditPage : ContentPage, IQueryAttributable
{
    private readonly BaseEditPageLogic<Models.Mount> _base;

    public MountsEditPage(MountsEditViewModel viewModel)
    {
        InitializeComponent();
        _base = new BaseEditPageLogic<Models.Mount>(viewModel);
        _base.SetupPage(this);
        this.LogInfo("🚀 REFACTORED MountsEditPage - using BaseEditPageLogic composition");
    }
