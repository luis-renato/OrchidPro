...
/// <summary>
/// SourcesEditPage - seguindo padrão FamilyEditPage
/// </summary>
public partial class SourcesEditPage : ContentPage, IQueryAttributable
{
    private readonly BaseEditPageLogic<Models.Source> _base;

    public SourcesEditPage(SourcesEditViewModel viewModel)
    {
        InitializeComponent();
        _base = new BaseEditPageLogic<Models.Source>(viewModel);
        _base.SetupPage(this);
        this.LogInfo("🚀 REFACTORED SourcesEditPage - using BaseEditPageLogic composition");
    }
